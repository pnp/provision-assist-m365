...
•	{"fr": {"Welcome": "Bienvenue", "Language": "Langue", "SelectLanguage": "Sélectionnez votre langue", ...}}
You also need to add a new option to the Language drop-down menu in the app, with the value set to the language code and the label set to the translation of the word "Language" in that language. For example, to add French as a new option, you need to add this item to the drop-down menu:
•	{Value: "fr", Label: TranslationLibrary["fr"].Language}
For more detailed information on how the TranslationLibrary component was built, you can refer to this URL: https://learn.microsoft.com/en-us/power-apps/maker/canvas-apps/multi-language-apps
